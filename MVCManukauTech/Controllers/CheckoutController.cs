...
namespace MVCManukauTech.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        //SKH Added user manager to get object of person who is logged in
        ...
        //11042019 NV Create Checkout controller and methods
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        public IActionResult Index()
        {
            //NV Calculate the grand total for display and processing
            int orderId = Convert.ToInt32(HttpContext.Session.GetInt32("OrderId"));

            //NV Use the orderId to get the GrandTotal out of the database
            ...
            try
            {
                ...
                //SKH Discount application if a gold/silver/bronze member is logged in
                if (isLoggedIn() == true)
                {                    
            ...
            // If for any reason checkout has an error, user is redirected to catalog page.
            catch
            {
        ...
        //11042019 NV Get paypal id from paypal and write to database as transaction id. Return message to view to proceed with next steps
        ...
        //12042019 NV write order details to database after successful payment
        ...
        //12042019 NV change quantity of products when buyer buys a product
