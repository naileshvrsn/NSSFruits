...
namespace MVCManukauTech.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        // 09042019 NV Create cart controller and views from JPC XSpy Project
        ...
        // SKH Check cart so that user cannot buy two types of membership
